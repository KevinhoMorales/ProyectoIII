...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ledView.backgroundColor = UIColor.lightGray
        ledView.layer.cornerRadius = ledView.bounds.size.height/2
        // --- ARKIT ---
    ...
    func classificationCompleteHandler(request: VNRequest, error: Error?) {
        ...
        DispatchQueue.main.async {
            ...
            if (topPredictionScore != nil && topPredictionScore! > 0.01) {
                ...
                if (topPredictionName == "fist-UB-RHand") { symbol = "E"
                    self.ledView.backgroundColor = UIColor.green }
                //if (topPredictionName == "FIVE-UB-RHand") { symbol = "🖐" }
                if (topPredictionName == "FIVE-UB-RHand") { symbol = "5"
                    self.ledView.backgroundColor = UIColor.green }
            }
